...
<div>
    <el-menu default-active="1" :default-openeds="dftOpen" class="el-menu-vertical-demo menu" router>
        ...
        <el-submenu index="1">
            ...
            <el-menu-item index="5-2" route="/back/hotel-list">新增酒店和客房</el-menu-item>
            <el-menu-item-group>
                <template slot="title">
                    <span>产品</span>
                </template>
        ...
        <el-submenu index="2">
            ...
            <el-menu-item-group>
                <el-menu-item index="2-1" route="/back/hotel/open-orders-lzd">酒店预订单</el-menu-item>
                <el-menu-item index="2-2">预售券预约</el-menu-item>
                <el-menu-item index="2-3">商户订单</el-menu-item>
            </el-menu-item-group>
        ...
        <el-submenu index="7">
            ...
            <el-menu-item index="7-1">会员</el-menu-item>
            <el-menu-item index="7-2">会员等级</el-menu-item>
        </el-submenu>
